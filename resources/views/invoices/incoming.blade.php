            ...
            <div class="card">
                ...
                <form method="GET" action="{{ route('invoices.incoming') }}" class="mb-4" id="filterForm">
                    <div class="row g-3">
                        ...
                        <!-- Arama ve Ara Butonu (aynı satırda) -->
                        <div class="col-md-6">
                        ...
                        <div class="col-12 d-flex flex-wrap mt-3">
                            <div class="btn-group me-2 mb-2">
                                ...
                                <a href="{{ route('invoices.incoming', array_merge(request()->all(), ['unprocessed' => 1])) }}"
                                   class="btn btn-outline-warning {{ request('unprocessed') ? 'active' : '' }}">
                                    ⏳ İşlenmeyen
                                </a>
                                ...
                                @if(request()->hasAny(['start_date','end_date','search','missing','unprocessed']))
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th>Tutar</th>
                                @php
                                    $currentSort = request('sort', 'n.issue_date');
                                    $currentDirection = request('direction', 'desc');
                                    $newDirection = ($currentSort === 'n.issue_date' && $currentDirection === 'asc') ? 'desc' : 'asc';
                                @endphp

                                <th>
                                    <a href="{{ route('invoices.incoming', array_merge(request()->all(), ['sort' => 'n.issue_date', 'direction' => $newDirection])) }}">
                                        Tarih
                                        @if($currentSort === 'n.issue_date')
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <th><small class="text_muted">{{ $invoice->ref_number }}</small></th>
